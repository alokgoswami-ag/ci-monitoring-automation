...
def get_node_status(spy_link):
    ...
    try:
        ...
        if "NAME" in node_log_response.text:
            ...
            elif ((job_platform == "mce" or "compact" in node_log_url ) and response_str.count(no_of_worker) != 3) or ((job_platform != "mce" and "compact" not in node_log_url) and response_str.count(no_of_worker) != 2):
